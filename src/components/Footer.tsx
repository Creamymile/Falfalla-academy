      ...
      <div className="footer-grid">
        <div className="footer-brand">
          ...
          <div className="footer-social">
            <a href="https://instagram.com/falfalla_academy" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <InstagramIcon />
            </a>
            <a href="mailto:support@falfalla-academy.com" aria-label="Email">
              <Mail size={18} />
            </a>
          </div>
        </div>
